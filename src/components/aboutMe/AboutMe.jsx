        ...
        <div className="aboutme" id="aboutme">
                ...
                <div className="wrapper">
                    ...
                    < div className='about-me-options'>
                        ...
                        <a href='https://www.instagram.com/willedwards00/'>
                            ...
                            <a href='https://www.linkedin.com/in/willedwards-0/'>
                                <i className='fa fa-linkedin'></i>
                            </a>
                            <a href='https://github.com/wille5656?tab=repositories'>
            ...
            <div className='container-2'>
                ...
                <div className="text-2">
                    ...
                    <p>Intern at Hubspire</p>
                    <p>1 Year of Developer Experience</p>
                    <p>Good Management and Communication</p>
                    <p>Team Player</p>
                </div>
            </div>
        </section>
